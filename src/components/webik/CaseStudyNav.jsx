          ...
          <div className="hidden lg:flex items-center gap-8">
            ...
            <div className="relative" ref={dropdownRef}>
              <button
                ...
                className="flex items-center gap-1 text-sm font-inter font-medium transition-colors"
                style={{ color: 'var(--webik-muted)' }}
                onMouseEnter={e => e.currentTarget.style.color = 'var(--webik-cream)'}
                onMouseLeave={e => e.currentTarget.style.color = workOpen ? 'var(--webik-cream)' : 'var(--webik-muted)'}
              >
                Work
              ...
              {workOpen && (
                <div
                  ...
                  style={{ background: 'var(--webik-dark-2)', border: '1px solid rgba(245,243,236,0.1)' }}
                >
                  <Link
                    to="/work"
